	...
	P::Signature: TryFrom<Vec<u8>> + Member + Codec,
{
	...
	///
	/// Provide the slot to build at as well as any other necessary pre-vrf logs,
	/// the inherent data, and the proposal duration and PoV size limits.
	///
	/// The Aura pre-vrf should not be explicitly provided and is set internally.
	///
...
impl<Pub> SlotClaim<Pub> {
	...
	/// Get the Aura pre-vrf for this slot.
